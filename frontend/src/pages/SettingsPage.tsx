        ...
        <div className="max-w-2xl mx-auto py-8 px-4 space-y-6 page-enter">
            ...
            <Card>
                ...
                <CardContent className="space-y-4">
                    <PathInput
                        ...
                        onReset={() =>
                            update("watch_folder", defaults?.watch_folder ?? "")
                        }
                        mode="folder"
                    ...
                    <PathInput
                        ...
                        onReset={() =>
                            update("dest_folder", defaults?.dest_folder ?? "")
                        }
                        mode="folder"
                        placeholder="C:/Videos/Clips"
                    />
                    <p className="text-xs text-muted-foreground mt-2!">
                        Подсказка: если хотите хранить клипы в одной папке без
                        перемещения - укажите одинаковые папки OBS и назначения,
                        и выберите режим сортировки "Без сортировки".
                    </p>
                </CardContent>
            </Card>
            ...
            <Card>
                <CardHeader className="pb-3">
                    ...
                    <CardDescription>
                        Как организовывать клипы по подпапкам
                    </CardDescription>
                </CardHeader>
                <CardContent className="space-y-4">
                    ...
                    {settings.sort_mode === "date" && (
                        <div className="space-y-1.5">
                            ...
                            <p className="text-xs text-muted-foreground mt-2!">
                                Пример: <code>{"{year}/{month}"}</code> создаст
                                2 папки, клип сохранится в последнюю из них :{" "}
                                <code>2026/03</code>
                            </p>
                        </div>
                    )}
            ...
            <Card>
                <CardHeader className="pb-3">
                    ...
                    <CardDescription>
                        Как называть сохранённые клипы
                    </CardDescription>
                </CardHeader>
            ...
            <Card>
                ...
                <CardContent className="space-y-4">
                            ...
                            <div className="space-y-2">
                                <div className="flex items-center justify-between">
                                    ...
                                    <span className="text-sm text-muted-foreground">
                                        {Math.round(
                                            settings.notification_volume * 100,
                                        )}
                                        %
                                    </span>
                                </div>
                    ...
                    <div className="space-y-2">
                        <div className="flex items-center justify-between">
                            <Label>
                                Громкость воспроизведения видео по умолчанию
                            </Label>
                            <span className="text-sm text-muted-foreground">
                                {Math.round(
                                    settings.player_default_volume * 100,
                                )}
                                %
                            </span>
                        </div>
                        <Slider
                            ...
                            onValueChange={([v]) =>
                                update("player_default_volume", v)
                            }
                        />
                    </div>
                </CardContent>
                    ...
                    <div className="flex flex-col justify-between gap-5">
                        <div className="text-left">
                            ...
                            <div className="text-xs text-muted-foreground mt-0.5">
                                <p>
                                    Определяет качество картинок, которые вы
                                    видите при наведении на таймлайн при
                                    просмотре видео. Чем больше число - тем хуже
                                    качество. Значение по умолчанию - 10, этого
                                    достаточно для большинства случаев. Полезно
                                    повысить и пересоздать кэш, если у вас много
                                    клипов и жалко места.
                                    <br />
                                    <br />1 - лучшее качество, наибольший размер
                                    <br />
                                    31 - худшее качество, маленький размер
                                </p>
                            </div>
                        </div>
